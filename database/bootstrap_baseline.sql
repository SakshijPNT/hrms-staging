...
-- Matches EF migration: 20260507054951_BaselineExistingSchema
-- Run this BEFORE starting hrms-app on an empty database.
-- EF migrations will then add remaining columns/tables automatically.
...
CREATE UNIQUE INDEX uq_rolemaster_rolename ON rolemaster(rolename);
...
CREATE UNIQUE INDEX uq_activitymaster_activitycode ON activitymaster(activitycode);
