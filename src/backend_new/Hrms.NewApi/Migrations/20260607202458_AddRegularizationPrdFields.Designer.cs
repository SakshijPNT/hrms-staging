...
namespace Hrms.NewApi.Migrations
{
    ...
    [Migration("20260607202458_AddRegularizationPrdFields")]
    partial class AddRegularizationPrdFields
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("attendanceregularizations", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("chk_ar_correction_type", "requestedcorrectiontype IN ('FULL_DAY','HALF_DAY')");

                            t.HasCheckConstraint("chk_ar_original_status", "originalattendancestatus IN ('ABSENT','HALF_DAY','SHORT_DAY')");
