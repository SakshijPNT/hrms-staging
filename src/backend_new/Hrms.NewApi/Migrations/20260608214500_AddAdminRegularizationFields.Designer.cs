...
namespace Hrms.NewApi.Migrations
{
    ...
    [Migration("20260608214500_AddAdminRegularizationFields")]
    partial class AddAdminRegularizationFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hrms.NewApi.Models.AdminAttendanceCorrection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("LogDate")
                        .HasDatabaseName("idx_aac_logdate");

                    b.HasIndex("UserId")
                        .HasDatabaseName("idx_aac_userid");

                    b.ToTable("admin_attendance_corrections", (string)null);
                });
            ...
            modelBuilder.Entity("Hrms.NewApi.Models.UserAttendanceLog", b =>
                {
                    ...
                    b.Property<bool>("IsAdminCorrected")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("isadmincorrected");
